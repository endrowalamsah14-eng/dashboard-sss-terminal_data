...
try:
    ...
    df_config_library = pd.DataFrame([
        ...
        {"VENDOR": "JEJE", "UNIQUE CODE": "FCL", "KEY DESTINATION": "MAKASSAR", "TONASE TARGET (kg)": 7000.0, "GROUP DESTINATION": "Makassar DC, Maros DC, Tamalanrea DC"},
        ...
        {"VENDOR": "JEJE", "UNIQUE CODE": "FCL", "KEY DESTINATION": "BANJARMASIN", "TONASE TARGET (kg)": 14000.0, "GROUP DESTINATION": "Banjarmasin DC, Banjarbaru DC, Banjarmasin 2 DC"},
        {"VENDOR": "SAKAR", "UNIQUE CODE": "FCL", "KEY DESTINATION": "BANJARMASIN", "TONASE TARGET (kg)": 3500.0, "GROUP DESTINATION": "Banjarmasin DC, Banjarbaru DC, Banjarmasin 2 DC"},
